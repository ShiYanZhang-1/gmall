...
MySQL - 5.7.22-log : Database - guli_wms
*********************************************************************
*/
...
/*Table structure for table `wms_feight_template` */
...
CREATE TABLE `wms_feight_template` (
  ...
  `charge_type` tinyint(4) DEFAULT NULL COMMENT '计费类型【0->按重量，1->按件数】',
  `first_weight` decimal(10,0) DEFAULT NULL COMMENT '首重',
  `first_fee` decimal(10,0) DEFAULT NULL COMMENT '首费',
  `continue_weight` decimal(10,0) DEFAULT NULL COMMENT '续重',
  `continue_fee` decimal(10,0) DEFAULT NULL COMMENT '续费',
  `dest` bigint(20) DEFAULT NULL COMMENT '目的地',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='运费模板';

/*Data for the table `wms_feight_template` */

/*Table structure for table `wms_sh_area` */
...
CREATE TABLE `wms_sh_area` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3750 DEFAULT CHARSET=utf8 COMMENT='全国省市区信息';

/*Data for the table `wms_sh_area` */

insert  into `wms_sh_area`(`id`,`pid`,`shortname`,`name`,`merger_name`,`level`,`pinyin`,`code`,`zip_code`,`first`,`lng`,`lat`) values 
...
CREATE TABLE `wms_ware_sku` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='商品库存';
