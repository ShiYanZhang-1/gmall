...
MySQL - 5.7.22-log : Database - guli_sms
*********************************************************************
*/
...
insert  into `sms_coupon`(`id`,`coupon_type`,`coupon_img`,`coupon_name`,`num`,`amount`,`per_limit`,`min_point`,`start_time`,`end_time`,`use_type`,`note`,`publish_count`,`use_count`,`receive_count`,`enable_start_time`,`enable_end_time`,`code`,`member_level`,`publish`) values 
(1,0,NULL,'fdsaf',1,1,1,111,'2019-07-25 07:52:48','2019-07-26 08:00:00',1,'啥事',111,NULL,NULL,'2019-07-25 07:52:54','2019-07-28 07:52:56','',2,NULL),
(2,1,NULL,'dsad ',1,1,1,1,'2019-07-25 07:53:32','2019-07-27 08:00:00',2,'daad',22,NULL,NULL,'2019-07-25 07:53:40','2019-07-27 08:00:00','',1,NULL);
...
insert  into `sms_coupon_spu_category_relation`(`id`,`coupon_id`,`category_id`,`category_name`) values 
(1,1,225,'手机'),
(2,1,226,'对讲机');
...
insert  into `sms_coupon_spu_relation`(`id`,`coupon_id`,`spu_id`,`spu_name`) values 
(1,2,1,'华为1'),
(2,2,2,'华米');
...
CREATE TABLE `sms_sku_bounds` (
  ...
  `work` tinyint(1) DEFAULT NULL COMMENT '优惠生效情况[1111（四个状态位，从右到左）;0 - 无优惠，成长积分是否赠送;1 - 无优惠，购物积分是否赠送;2 - 有优惠，成长积分是否赠送;3 - 有优惠，购物积分是否赠送【状态位0：不赠送，1：赠送】]',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COMMENT='商品sku积分设置';

/*Data for the table `sms_sku_bounds` */

insert  into `sms_sku_bounds`(`id`,`sku_id`,`grow_bounds`,`buy_bounds`,`work`) values 
(1,7,0,0,0),
(2,8,0,0,0),
(3,9,0,0,0),
(4,10,100,100,10),
