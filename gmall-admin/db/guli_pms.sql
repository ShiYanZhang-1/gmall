...
MySQL - 5.7.22-log : Database - guli_pms
*********************************************************************
*/
...
(1,'电池容量',1,0,'http://gulimall.oss-cn-shanghai.aliyuncs.com/2019-07-23/83ff5db8-6cf2-4dc8-8cea-9e82c477383f_u43.png','[\"3000mAh\",\"4000mAh\",\"5000mAh\"]',1,NULL,225,NULL),
(2,'尺寸',0,0,'http://gulimall.oss-cn-shanghai.aliyuncs.com/2019-07-23/059e04c6-ece0-438f-84af-7572f4abad91_u43.png','[\"42\",\"55\",\"65\",\"100\"]',0,NULL,225,NULL),
(3,'颜色',0,0,'http://gulimall.oss-cn-shanghai.aliyuncs.com/2019-07-24/dd9d0bbe-89ef-46db-818c-48fbace69ba4_u43.png','[\"黑色\",\"白色\",\"粉色\"]',0,1,225,NULL),
(4,'内存',0,0,'','6g,8g',0,1,225,0),
(5,'屏幕',1,1,'','4,5,6,7',1,1,225,1);
...
CREATE TABLE `pms_attr_attrgroup_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='属性&属性分组关联';
...
(1,'主体',NULL,'手机的主体信息',NULL,225),
(2,'基本信息',NULL,'手机的基本信息',NULL,225);
...
(4,'京东','http://gulimall.oss-cn-shanghai.aliyuncs.com/2019-07-18/299c55e31d7f50ae4dc85faa90d6f445_121_121.jpg','www.jd.com',1,'j',NULL),
(5,'小米','https://jdbc.oss-cn-beijing.aliyuncs.com/gmall/2020/01/11/ef9916bb-acfa-478f-811c-6d891a92bda7_logo.png','Are you OK',1,'X',NULL);
...
CREATE TABLE `pms_product_attr_value` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4 COMMENT='spu属性值';
...
(1,5,1,'电池容量','[\"3000mAh\"',0,0),
(2,5,2,'尺寸','[\"42\"',0,0),
(3,5,3,'颜色','[\"黑色\"',0,0),
(4,5,4,'内存','6g',0,0),
(5,5,5,'屏幕','4',0,0),
(21,10,1,'电池容量','[\"3000mAh\"',0,0),
(22,10,2,'尺寸','[\"42\"',0,0),
(23,10,3,'颜色','[\"黑色\"',0,0),
(24,10,4,'内存','6g',0,0),
(25,10,5,'屏幕','4',0,0),
(31,12,1,'电池容量','\"4000mAh\"',0,0),
(32,12,2,'尺寸','\"55\"',0,0),
(33,12,3,'颜色','\"白色\"',0,0),
(34,12,4,'内存','8g',0,0),
(35,12,5,'屏幕','4',0,0),
(41,14,1,'电池容量','[\"3000mAh\",\"4000mAh\",\"5000mAh\"]',0,0),
(42,14,2,'尺寸','[\"42\",\"55\",\"65\",\"100\"]',0,0),
(43,14,3,'颜色','[\"黑色\",\"白色\",\"粉色\"]',0,0),
(44,14,4,'内存','6g,8g',0,0),
(45,14,5,'屏幕','4,5,6,7',0,0);
...
CREATE TABLE `pms_sku_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='sku图片';

/*Data for the table `pms_sku_images` */

insert  into `pms_sku_images`(`id`,`sku_id`,`img_url`,`img_sort`,`default_img`) values 
(2,11,'https://jdbc.oss-cn-beijing.aliyuncs.com/gmall/2020/01/12/4287885c-b820-435e-8981-2925f4593212_logo.png',0,1),
(3,12,'https://jdbc.oss-cn-beijing.aliyuncs.com/gmall/2020/01/12/3cf0353a-6def-444e-8517-e1fe8c2d36bc_logo.png',0,1),
(5,14,'https://jdbc.oss-cn-beijing.aliyuncs.com/gmall/2020/01/17/331a292b-f800-41c9-8f61-94293b89d58e_logo.png',0,1),
(6,15,'https://jdbc.oss-cn-beijing.aliyuncs.com/gmall/2020/01/17/8cd361b5-ff79-46ed-8356-a358d6351a82_logo.png',0,1);
...
CREATE TABLE `pms_sku_info` (
  ...
  `sku_code` char(128) DEFAULT NULL,
  ...
  PRIMARY KEY (`sku_id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COMMENT='sku信息';

/*Data for the table `pms_sku_info` */

insert  into `pms_sku_info`(`sku_id`,`spu_id`,`sku_code`,`sku_name`,`sku_desc`,`catalog_id`,`brand_id`,`sku_default_img`,`sku_title`,`sku_subtitle`,`price`,`weight`) values 
(1,1,'123','华为白色128g',NULL,225,4,NULL,NULL,NULL,1999,NULL),
(2,1,'222','华为黑色256g',NULL,225,4,NULL,NULL,NULL,2999,NULL),
(3,1,'3333','华为绿色64g',NULL,225,4,NULL,NULL,NULL,1299,NULL),
(8,10,'F9AD43B2-4','王者荣耀 [\"42\",\"白色\",6g','',225,5,NULL,'王者荣耀 [\"42\",\"白色\",6g','王者荣耀 [\"42\",\"白色\",6g',500,0),
(9,10,'11461A0B-2','王者荣耀 [\"42\",\"粉色\"],6g','',225,5,NULL,'王者荣耀 [\"42\",\"粉色\"],6g','王者荣耀 [\"42\",\"粉色\"],6g',600,0),
(11,12,'86ED6F92-F','华为Mate 20 X (5G) \"55\",\"白色\",6g','华为Mate',225,4,'https://jdbc.oss-cn-beijing.aliyuncs.com/gmall/2020/01/12/4287885c-b820-435e-8981-2925f4593212_logo.png','华为 HUAWEI Mate20 X (5G) 7nm工艺5G旗舰芯片全面屏超大广角徕卡三摄8GB+256GB宝石蓝5G双模全网通手机','【享12期免息！】直降1300，到手价4899；至高享24期免息，5.2元/天买5G》',1000,500),
(12,12,'14137164-F','华为Mate 20 X (5G) \"55\",\"粉色\"],6g','华为Mate',225,4,'https://jdbc.oss-cn-beijing.aliyuncs.com/gmall/2020/01/12/3cf0353a-6def-444e-8517-e1fe8c2d36bc_logo.png','华为 HUAWEI Mate20 X (5G) 7nm工艺5G旗舰芯片全面屏超大广角徕卡三摄8GB+256GB翡冷翠5G双模全网通手机','【享12期免息！】直降1300，到手价4899；至高享24期免息，5.2元/天买5G》',1200,500),
(14,14,'37AAE17B-A','苹果手机 \"65\",\"白色\",8g','苹果手机 \"65\",\"白色\",8g',225,5,'https://jdbc.oss-cn-beijing.aliyuncs.com/gmall/2020/01/17/331a292b-f800-41c9-8f61-94293b89d58e_logo.png','苹果手机 \"65\",\"白色\",8g','苹果手机 \"65\",\"白色\",8g',1000,100),
(15,14,'D2919788-3','苹果手机 \"65\",\"白色\",6g','苹果手机 \"65\",\"白色\",6g',225,5,'https://jdbc.oss-cn-beijing.aliyuncs.com/gmall/2020/01/17/8cd361b5-ff79-46ed-8356-a358d6351a82_logo.png','苹果手机 \"65\",\"白色\",6g','苹果手机 \"65\",\"白色\",6g',2000,222);
...
CREATE TABLE `pms_sku_sale_attr_value` (
  ...
  `attr_sort` int(11) DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COMMENT='sku销售属性&值';
...
CREATE TABLE `pms_spu_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COMMENT='spu信息';

/*Data for the table `pms_spu_info` */

insert  into `pms_spu_info`(`id`,`spu_name`,`spu_description`,`catalog_id`,`brand_id`,`publish_status`,`create_time`,`update_time`) values 
(1,'华为1','华为',225,0,1,'2019-07-17 08:00:00','2019-07-17 08:00:00'),
(2,'华米','华为',225,0,1,'2019-07-17 08:00:00','2019-07-17 08:00:00'),
(3,'小米','华为',225,0,1,'2019-07-17 08:00:00','2019-07-17 08:00:00'),
(4,'vivi','华为',225,0,1,'2019-07-17 08:00:00','2019-07-17 08:00:00'),
(5,'王者荣耀','5V5手游',225,5,1,'2020-01-11 19:21:20','2020-01-11 19:21:20'),
(10,'王者荣耀','5V5手游',225,5,1,'2020-01-11 19:32:50','2020-01-11 19:32:50'),
(12,'华为Mate 20 X (5G)','华为手机',225,4,1,'2020-01-12 10:29:15','2020-01-12 10:29:15'),
(14,'苹果手机','IPhone 20',225,5,1,'2020-01-17 20:34:52','2020-01-17 20:34:52');
...
(10,'https://jdbc.oss-cn-beijing.aliyuncs.com/gmall/2020/01/11/9ca1a8f7-3cf3-40c6-8973-60e44b7c5f88_loading.gif'),
(12,'https://jdbc.oss-cn-beijing.aliyuncs.com/gmall/2020/01/12/cd8c32f3-d259-4fca-844e-a9768ca036ea_logo.png'),
(14,'https://jdbc.oss-cn-beijing.aliyuncs.com/gmall/2020/01/17/af65f149-1831-4fd1-8cc9-3451adc6f7ea_logo.png');
